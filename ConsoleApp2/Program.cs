...
namespace ConsoleApp2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            sm4.SecretKey = "ag5df4g5aew6gra6gdf";
            sm4.HexString = false;

            #region 数据加密
            string teststr2 = "{\"param\":\"1\"}";
            teststr2 = sm4.EncodeBySM4(teststr2);
            Console.WriteLine("加密后的数据：" + teststr2);
            #endregion

            #region 数据解密
            string teststr3 = "emRSlFbdJZZ9LSrN02fTseFAC1MZ5OqloeSCeVj/rRCcmrExfc85xKWojU93N1jkp2jOYWjo7wK7/3pR35hr6YR0d3FYXbWxUpLAvTCfZTVluVrd+nuOVAfcnAO0j43F";
            teststr3 = sm4.DecodeBySM4(teststr3);
            Console.WriteLine("解密后的数据：" + teststr3);
            #endregion
    ...
    public class SM4Util
    {
        ...
        public string EncodeBySM4(String plainText)
        {
            String cipherText = Encrypt_ECB(plainText);
            return cipherText;
        }
        /// <summary>
        /// SM4解密方法
        ...
        public string DecodeBySM4(String cipherText)
        {
            string plainText = Decrypt_ECB(cipherText);
            return plainText;
        }
        /// <summary>
        /// SM4 ECB模式加密，由EncodeBySM4方法调用
        /// </summary>
        /// <param name="plainText"></param>
        /// <returns></returns>
        private String Encrypt_ECB(String plainText)
        {
        ...
        /// <summary>
        /// SM4 ECB模式解密 由DecodeBySM4调用
        /// </summary>
        /// <param name="cipherText"></param>
        /// <returns></returns>
        private String Decrypt_ECB(String cipherText)
        {
            SM4_Context ctx = new SM4_Context();
            ctx.isPadding = true;
    ...
    public class SM4
    {
        ...
        public byte[] SboxTable = new byte[] { 0xd6, 0x90, 0xe9, 0xfe, 0xcc, 0xe1, 0x3d, 0xb7, 0x16, 0xb6,
            0x14, 0xc2, 0x28, 0xfb, 0x2c, 0x05, 0x2b, 0x67, 0x9a, 0x76, 0x2a, 0xbe, 0x04, 0xc3,
            0xaa, 0x44, 0x13, 0x26, 0x49, 0x86, 0x06, 0x99, 0x9c, 0x42, 0x50, 0xf4, 0x91,
            0xef, 0x98, 0x7a, 0x33, 0x54, 0x0b, 0x43, 0xed, 0xcf, 0xac, 0x62, 0xe4,
            0xb3, 0x1c, 0xa9, 0xc9, 0x08, 0xe8, 0x95, 0x80, 0xdf, 0x94, 0xfa,
            0x75, 0x8f, 0x3f, 0xa6, 0x47, 0x07, 0xa7,
            0xfc, 0xf3, 0x73, 0x17, 0xba, 0x83, 0x59, 0x3c, 0x19, 0xe6, 0x85, 0x4f, 0xa8, 0x68, 0x6b, 0x81, 0xb2, 0x71, 0x64, 0xda,
            0x8b, 0xf8, 0xeb, 0x0f, 0x4b, 0x70, 0x56, 0x9d, 0x35, 0x1e, 0x24, 0x0e, 0x5e, 0x63, 0x58, (byte) 0xd1,
            0xa2, 0x25, 0x22, 0x7c, 0x3b, 0x01, 0x21, 0x78, (byte) 0x87,
            0xd4, 0x00, 0x46, 0x57, 0x9f, (byte) 0xd3, 0x27,
            0x52, 0x4c, 0x36, 0x02, 0xe7, (byte) 0xa0, (byte) 0xc4,
            0xc8, 0x9e, 0xea, 0xbf, (byte) 0x8a,
            0xd2, 0x40, 0xc7, 0x38, (byte) 0xb5, (byte) 0xa3,
            0xf7, 0xf2, 0xce, (byte) 0xf9, 0x61, 0x15,
            0xa1, 0xe0, 0xae, 0x5d, 0xa4,
            0x9b, 0x34, 0x1a, 0x55, 0xad, 0x93, 0x32,
            0x30, 0xf5, (byte)0x8c, 0xb1, 0xe3, 0x1d,
            0xf6, 0xe2, 0x2e, 0x82, 0x66, 0xca,
            0x60, 0xc0, 0x29, 0x23, 0xab, 0x0d, 0x53, 0x4e, 0x6f,
            0xd5, 0xdb, 0x37, 0x45, 0xde, (byte) 0xfd,
            0x8e, 0x2f, 0x03, (byte) 0xff, 0x6a, 0x72, 0x6d, 0x6c, 0x5b,
            0x51, 0x8d, 0x1b, (byte) 0xaf, (byte) 0x92, (byte) 0xbb,
            0xdd, 0xbc, 0x7f, 0x11, (byte) 0xd9, 0x5c, 0x41,
            0x1f, 0x10, 0x5a, (byte) 0xd8, 0x0a, (byte) 0xc1, 0x31,
            0x88, 0xa5, 0xcd, 0x7b,  0xbd, 0x2d,
            0x74, 0xd0, 0x12, (byte) 0xb8, (byte) 0xe5, (byte) 0xb4,
